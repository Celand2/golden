...
<div class="space-y-6">
    <section class="rounded-[32px] bg-white p-6 shadow-sm">
        <div class="grid gap-4 sm:grid-cols-4">
            ...
            <div class="rounded-3xl bg-white p-5 shadow-sm">
                <p class="text-sm uppercase text-slate-500">Depôts en attente</p>
                <p class="mt-4 text-3xl font-semibold text-slate-900">{{ $pendingDeposits->count() }}</p>
            </div>
            <div class="rounded-3xl bg-white p-5 shadow-sm">
                <p class="text-sm uppercase text-slate-500">Retraits en attente</p>
                <p class="mt-4 text-3xl font-semibold text-slate-900">{{ $pendingWithdrawals->count() }}</p>
            </div>
            <div class="rounded-3xl bg-white p-5 shadow-sm">
                <p class="text-sm uppercase text-slate-500">Investments actifs</p>
                <p class="mt-4 text-3xl font-semibold text-slate-900">{{ $activeInvestments }}</p>
            </div>
        </div>
    </section>
    ...
    <section class="rounded-[32px] bg-white p-6 shadow-sm">
        <h2 class="text-xl font-semibold text-slate-900">Coordonnées Lumicash</p>
